#' ---
#' title: Simulation study to assess adjusted predictions in GEEs (binary distributed responses).
...
here::i_am("simulations/binary_n25m10.R")
library(here)
...
save(all_results, file = here("simulations", "binaryresp_AR1margcor_n25m10.RData"))
...
all_results <- foreach(k0 = (1:1000)) %dopar% sim_fn(k0 = k0,
                                                     ...
                                                     test_timepoints = 6:10,
                                                     true_correlation_structure = true_correlation_structure)
save(all_results, file = here("simulations", "binaryresp_exchmargcor_n25m10.RData"))
...
all_results <- foreach(k0 = (1:1000)) %dopar% sim_fn(k0 = k0,
                                                     ...
                                                     test_timepoints = 6:10,
                                                     true_correlation_structure = true_correlation_structure)
save(all_results, file = here("simulations", "binaryresp_toepmargcor_n25m10.RData"))
...
all_results <- foreach(k0 = (1:1000)) %dopar% sim_fn(k0 = k0,
                                                     ...
                                                     test_timepoints = 6:10,
                                                     true_correlation_structure = "ar1")
save(all_results, file = here("simulations", "binaryresp_unstrucmargcor_n25m10.RData"))

#' ---
#' title: Simulation study to assess adjusted predictions in GEEs (Gaussian distributed responses).
...
here::i_am("simulations/gaussian_n25m10.R")
library(here)
...
save(all_results, file = here("simulations", "gaussianresp_AR1margcor_n25m10.RData"))
...
all_results <- foreach(k0 = (1:1000)) %dopar% sim_fn(k0 = k0,
                                                     ...
                                                     test_timepoints = 6:10,
                                                     true_correlation_structure = true_correlation_structure)
save(all_results, file = here("simulations", "gaussianresp_exchmargcor_n25m10.RData"))
#load(file = "gaussianresp_exchmargcor_n25m10.RData")
...
all_results <- foreach(k0 = (1:1000)) %dopar% sim_fn(k0 = k0,
                                                     ...
                                                     test_timepoints = 6:10,
                                                     true_correlation_structure = true_correlation_structure)
save(all_results, file = here("simulations", "gaussianresp_toepmargcor_n25m10.RData"))
